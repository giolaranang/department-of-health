...
<table width="300" border="0" align="center">
  <tr>
    ...
    <td>
      ...
      <input name="curpwd" type="password" id="curpwd" maxlength="30" />
    </td>
  </tr>
  <tr>
    <td>New Password:</td>
    <td>
      ...
      <input name="newpassword" type="password" id="newpassword" maxlength="30" />
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <input name="connewpassword" type="password" id="connewpassword" maxlength="30" />
    </td>
  </tr>
  <tr>
