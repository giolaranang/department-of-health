...
$speaker_rem = '';
$sked_rem = '';
while($row=mysql_fetch_array($rsql2ssz)){
...
<td bgcolor="#FFFFFF" style='border:1px solid orange;'><textarea name="title_act" id='title' style='height:100px; width:240px; border:none;'<?php echo $out_stat;?>><?php echo $title; ?></textarea></td>
...
<tr bgcolor="pink">
<td><b>Venue</td>
<td bgcolor="#FFFFFF" style='border:1px solid orange;'><textarea name="venue_place" style='height:50px; width:240px; border:none;' <?php echo $out_stat;?>> <?php echo $venue; ?></textarea></td>
...
<input type='hidden' value='<?php echo $T_ID; ?>' name="train" id='train'>
<tr bgcolor="pink">
<td><b>Date</td>
<td bgcolor="#FFFFFF" style="text-align:center;" >
<font size="2"><b>From :</b></font>
          <select name="from_month" <?php echo $out_stat;?> style="color:black;">
		   ...
		   <select name="from_day" <?php echo $out_stat;?> style="color:black;margin-right:66px;">
...
<font size="2"><b>&nbsp;&nbsp;&nbsp;To :</b></font>
          <select name="to_month" <?php echo $out_stat;?> style="color:black;">
		   ...
		   <select name="to_day" <?php echo $out_stat;?> style="color:black;">
	...
	?>
		   ...
		   <select name="to_year" <?php echo $out_stat;?> style="color:black;">
...
<td bgcolor="#FFFFFF" style='border:1px solid orange;'><textarea name="venue_place" style='height:50px; width:240px; border:none;' <?php echo $out_stat;?>> <?php echo $p_budget; ?></textarea></td>
...
<tr bgcolor="pink">
<td><b>Fund Source</td>
<td bgcolor="#FFFFFF" style='border:1px solid orange;'><textarea name="venue_place" style='height:50px; width:240px; border:none;' <?php echo $out_stat;?>> <?php echo $f_source; ?></textarea></td>
...
<td bgcolor="#FFFFFF" style='border:1px solid orange;'><textarea name="venue_place" style='height:50px; width:240px; border:none;' <?php echo $out_stat;?>> <?php echo $speaker; ?></textarea></td>
...
<tr bgcolor="pink">
<td><b>Schedule</td>
<td bgcolor="#FFFFFF" style='border:1px solid orange;'><textarea name="venue_place" style='height:50px; width:240px; border:none;' <?php echo $out_stat;?>> <?php echo $schedule; ?></textarea></td>
...
echo "<style='background-color:white;'><a style='width:60; height:24' href=\"download.php?idss=".$T_ID."\"OnClick=\"return confirm('Do you want to download the attached file from this training?')\"><img src='../images/download.png'/ BORDER=0 HEIGHT=40 WIDTH=44></a></td>";
echo '</tr>';
?>
...
<table>
<tr>
<td colspan="2"><input type="radio" name="radio" value="approve" class="tablebott">Approve and Send Remarks</input></td>
<tr>
</tr>
<td  colspan="2"><input type="radio" name="radio" value="disapprove">Disapprove and Send Remarks</input></td>
</tr>
<tr>
<td  colspan="2"><input type="radio" name="radio" value="Changes">Send Remarks Only and Opt for Changes</input></td>
</tr>
<tr>
<td><input name = "submit" type="submit" value="Update" class="submitindex" onClick="return confirm('Confirm Update?')"></input></td>
</tr>
</table>
</div>
</form>
